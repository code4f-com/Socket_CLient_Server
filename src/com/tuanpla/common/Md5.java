...
public class Md5 {
    ...
    public static boolean checkAuthen(String str, String auth) {
...
////
    ...
    private void transform() {
        ...
        for (i = 0; i < 16; i++) {
            arrint[i] = GET_32BIT_LSB_FIRST(in, 4 * i);
        }
        ...
        a = MD5STEP(F1, a, b, c, d, arrint[0] + 0xd76aa478, 7);
        d = MD5STEP(F1, d, a, b, c, arrint[1] + 0xe8c7b756, 12);
        c = MD5STEP(F1, c, d, a, b, arrint[2] + 0x242070db, 17);
        b = MD5STEP(F1, b, c, d, a, arrint[3] + 0xc1bdceee, 22);
        a = MD5STEP(F1, a, b, c, d, arrint[4] + 0xf57c0faf, 7);
        d = MD5STEP(F1, d, a, b, c, arrint[5] + 0x4787c62a, 12);
        c = MD5STEP(F1, c, d, a, b, arrint[6] + 0xa8304613, 17);
        b = MD5STEP(F1, b, c, d, a, arrint[7] + 0xfd469501, 22);
        a = MD5STEP(F1, a, b, c, d, arrint[8] + 0x698098d8, 7);
        d = MD5STEP(F1, d, a, b, c, arrint[9] + 0x8b44f7af, 12);
        c = MD5STEP(F1, c, d, a, b, arrint[10] + 0xffff5bb1, 17);
        b = MD5STEP(F1, b, c, d, a, arrint[11] + 0x895cd7be, 22);
        a = MD5STEP(F1, a, b, c, d, arrint[12] + 0x6b901122, 7);
        d = MD5STEP(F1, d, a, b, c, arrint[13] + 0xfd987193, 12);
        c = MD5STEP(F1, c, d, a, b, arrint[14] + 0xa679438e, 17);
        b = MD5STEP(F1, b, c, d, a, arrint[15] + 0x49b40821, 22);

        a = MD5STEP(F2, a, b, c, d, arrint[1] + 0xf61e2562, 5);
        d = MD5STEP(F2, d, a, b, c, arrint[6] + 0xc040b340, 9);
        c = MD5STEP(F2, c, d, a, b, arrint[11] + 0x265e5a51, 14);
        b = MD5STEP(F2, b, c, d, a, arrint[0] + 0xe9b6c7aa, 20);
        a = MD5STEP(F2, a, b, c, d, arrint[5] + 0xd62f105d, 5);
        d = MD5STEP(F2, d, a, b, c, arrint[10] + 0x02441453, 9);
        c = MD5STEP(F2, c, d, a, b, arrint[15] + 0xd8a1e681, 14);
        b = MD5STEP(F2, b, c, d, a, arrint[4] + 0xe7d3fbc8, 20);
        a = MD5STEP(F2, a, b, c, d, arrint[9] + 0x21e1cde6, 5);
        d = MD5STEP(F2, d, a, b, c, arrint[14] + 0xc33707d6, 9);
        c = MD5STEP(F2, c, d, a, b, arrint[3] + 0xf4d50d87, 14);
        b = MD5STEP(F2, b, c, d, a, arrint[8] + 0x455a14ed, 20);
        a = MD5STEP(F2, a, b, c, d, arrint[13] + 0xa9e3e905, 5);
        d = MD5STEP(F2, d, a, b, c, arrint[2] + 0xfcefa3f8, 9);
        c = MD5STEP(F2, c, d, a, b, arrint[7] + 0x676f02d9, 14);
        b = MD5STEP(F2, b, c, d, a, arrint[12] + 0x8d2a4c8a, 20);

        a = MD5STEP(F3, a, b, c, d, arrint[5] + 0xfffa3942, 4);
        d = MD5STEP(F3, d, a, b, c, arrint[8] + 0x8771f681, 11);
        c = MD5STEP(F3, c, d, a, b, arrint[11] + 0x6d9d6122, 16);
        b = MD5STEP(F3, b, c, d, a, arrint[14] + 0xfde5380c, 23);
        a = MD5STEP(F3, a, b, c, d, arrint[1] + 0xa4beea44, 4);
        d = MD5STEP(F3, d, a, b, c, arrint[4] + 0x4bdecfa9, 11);
        c = MD5STEP(F3, c, d, a, b, arrint[7] + 0xf6bb4b60, 16);
        b = MD5STEP(F3, b, c, d, a, arrint[10] + 0xbebfbc70, 23);
        a = MD5STEP(F3, a, b, c, d, arrint[13] + 0x289b7ec6, 4);
        d = MD5STEP(F3, d, a, b, c, arrint[0] + 0xeaa127fa, 11);
        c = MD5STEP(F3, c, d, a, b, arrint[3] + 0xd4ef3085, 16);
        b = MD5STEP(F3, b, c, d, a, arrint[6] + 0x04881d05, 23);
        a = MD5STEP(F3, a, b, c, d, arrint[9] + 0xd9d4d039, 4);
        d = MD5STEP(F3, d, a, b, c, arrint[12] + 0xe6db99e5, 11);
        c = MD5STEP(F3, c, d, a, b, arrint[15] + 0x1fa27cf8, 16);
        b = MD5STEP(F3, b, c, d, a, arrint[2] + 0xc4ac5665, 23);

        a = MD5STEP(F4, a, b, c, d, arrint[0] + 0xf4292244, 6);
        d = MD5STEP(F4, d, a, b, c, arrint[7] + 0x432aff97, 10);
        c = MD5STEP(F4, c, d, a, b, arrint[14] + 0xab9423a7, 15);
        b = MD5STEP(F4, b, c, d, a, arrint[5] + 0xfc93a039, 21);
        a = MD5STEP(F4, a, b, c, d, arrint[12] + 0x655b59c3, 6);
        d = MD5STEP(F4, d, a, b, c, arrint[3] + 0x8f0ccc92, 10);
        c = MD5STEP(F4, c, d, a, b, arrint[10] + 0xffeff47d, 15);
        b = MD5STEP(F4, b, c, d, a, arrint[1] + 0x85845dd1, 21);
        a = MD5STEP(F4, a, b, c, d, arrint[8] + 0x6fa87e4f, 6);
        d = MD5STEP(F4, d, a, b, c, arrint[15] + 0xfe2ce6e0, 10);
        c = MD5STEP(F4, c, d, a, b, arrint[6] + 0xa3014314, 15);
        b = MD5STEP(F4, b, c, d, a, arrint[13] + 0x4e0811a1, 21);
        a = MD5STEP(F4, a, b, c, d, arrint[4] + 0xf7537e82, 6);
        d = MD5STEP(F4, d, a, b, c, arrint[11] + 0xbd3af235, 10);
        c = MD5STEP(F4, c, d, a, b, arrint[2] + 0x2ad7d2bb, 15);
        b = MD5STEP(F4, b, c, d, a, arrint[9] + 0xeb86d391, 21);
